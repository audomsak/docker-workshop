...
Docker volume can be categorized into two types - Anonymous volume and Named-volume. Anonymous volume's name is randomly generated, not human readible and hard to remember. It would be a nightmare if you have run many containers that use many anonymous volumes because you which volume belongs to which container. Named-volume can help in this case.
